...
- Run `npm run lint` (oxlint plus stylelint) and `npm run test` (vitest) after code changes; both are part of `npm run build` alongside the probe suites.

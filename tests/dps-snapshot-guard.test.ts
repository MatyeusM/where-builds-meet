...
describe("dps-snapshot-guard", () => {
  it("DPS snapshot guard: bidirectional 1% boundary, invalid results, fixture changes, and coverage checks passed", async () => {
    ...
    assert(
      compareDpsSnapshots({ example: sample(0) }, baseline).length > 0,
